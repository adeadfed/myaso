Private Function GetLSBM(ByVal Target As Byte, ByVal Source As Byte) As Byte
    GetLSBM = (Target * 2) Or (Source Mod 2)
End Function
    ...
    For y = 0 To Bmp.bmHeight - 1
        For x = 0 To Bmp.bmWidth - 1
            ...
            For k = 0 To 2
                ...
                bPayloadArr(lBytePos) = GetLSBM(bPayloadArr(lBytePos), bChannelsArr(k))
                lBitPos = lBitPos + 1
